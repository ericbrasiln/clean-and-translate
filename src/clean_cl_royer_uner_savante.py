...
def limpar_text(text):
    ...
    odd_pattern = re.compile(r'\d{3} LA REVUE')
    ...
    even_pattern = re.compile(r'CLÉMENCE ROYER \d{3}')
...
raw_text = 'raw_txt/CLÉMENCE ROYER_une savant.txt'    
clean_text = 'clean_txt/clemence_royer_une_savant.txt'
