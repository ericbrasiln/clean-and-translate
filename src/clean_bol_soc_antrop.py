...
def limpar_text(text):
    ...
    odd_pattern = re.compile(r'\d{3} SÉANCE DU 6 FÉVRIER 1890.')
    ...
    # find matches for the pattern 'CLÉMENCE ROYER. - A PROPOS D\'UN LÉZARD BIPÈDE. \d{3}'
    even_pattern = re.compile(r'CLÉMENCE ROYER. - A PROPOS D\'UN LÉZARD BIPÈDE. \d{3}')
...
raw_text = 'raw_txt/boletim sociedade antrop paris.txt'    
clean_text = 'clean_txt/boletim_sociedade_antrop_paris.txt'
